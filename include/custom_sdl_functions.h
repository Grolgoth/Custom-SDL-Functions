...
*/
void spin_surface_safe(SDL_Surface* target, unsigned int* previousSpins, unsigned int turns, std::vector<std::vector<int>> tileSets, bool right = false, SDL_Rect* clip = nullptr);
